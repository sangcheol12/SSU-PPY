...
public class OpChatAdapter extends FirestoreRecyclerAdapter<Chat, OpChatAdapter.ViewHolder> {
    ...
    public OpChatAdapter(@NonNull FirestoreRecyclerOptions<Chat> options) {
        super(options);
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == MSG_TYPE_RIGHT) {
            ...
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.other_op_chat, parent, false);
            return new ViewHolder(view,viewType);
        }
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, int viewType) {
            ...
            if(viewType == MSG_TYPE_RIGHT) {
                ...
                message = itemView.findViewById(R.id.other_chat_text);
            }
        }
    }
}
